...
sources_down: []
generated_at: "2026-08-24 07:32 UTC-07:00"
models_used: ["nemotron-3-ultra-free"]
---

**Key development:** The US just launched what Trump calls "economic D-Day" on Iran — the biggest financial offensive ever against Tehran — while Iran's currency crashes and it threatens to hit neighbors who cooperate.

## Iran-US Economic War

<details markdown="block">
<summary markdown="span">**(Update) Treasury Secretary Bessent just unveiled "economic D-Day" sanctions on Iran, calling it the single greatest financial offensive ever against an adversary.** This moves from threats to active implementation — Iran's already warning neighbors that joining in counts as an act of war. *(Euronews, BBC, NPR, DW)*</summary>
...
<details markdown="block">
<summary markdown="span">**Iran's currency just collapsed to a record low — over 2 million rials to the dollar — as markets price in the new sanctions. [UNCONFIRMED]** Tracking sites show the freefall accelerating ahead of the formal announcement. *(Middle East Eye)* The Hindu separately reports the rial at 2.02 million to the dollar, noting a wide gap with the official Central Bank rate of 1.5 million.</summary>
...
<details markdown="block">
<summary markdown="span">**Iran's security chief threatened to target neighbors' oil routes if they join the US sanctions, calling them "enemies" whose interests will be hit.** Mohsen Rezaei specifically named alternative shipping routes bypassing the Strait of Hormuz. *(The Hindu, Middle East Eye [UNCONFIRMED])*</summary>
...
<details markdown="block">
<summary markdown="span">**The US cancelled upcoming joint marine exercises with South Korea, citing force constraints from the Iran war. [UNCONFIRMED]** This follows Trump's order last week to cut the separate Ulchi Freedom Shield drills from 11 days to five. *(Al Jazeera [UNCONFIRMED], Euronews [UNCONFIRMED])*</summary>
...
<details markdown="block">
<summary markdown="span">**Greece moved a Patriot missile battery to Crete after Iranian sources reportedly threatened to hit US bases in Europe if Trump escalates in the Strait of Hormuz.** *(Euronews)*</summary>

Context: The Financial Times reported last week that Iran would fire missiles at US targets in Europe — including bases in Greece — if pressure on the Strait intensifies. Athens isn't waiting; the Patriot deployment to Crete puts air defense closer to potential flight paths from Iran.

Sources: [Euronews](http://www.euronews.com/my-europe/2026/08/24/greece-moves-patriot-system-to-crete-over-reported-iran-threats-to-us-bases)
...
<details markdown="block">
<summary markdown="span">**Israel confirmed its soldiers fired on the car where 5-year-old Hind Rajab was killed and opened a criminal investigation — nearly two years after the fact. [UNCONFIRMED]** The girl survived the initial attack and pleaded for help on a 911 call; her body was found days later with six relatives. *(BBC [UNCONFIRMED])*</summary>
...
<details markdown="block">
<summary markdown="span">**Israeli settlers and soldiers killed two Palestinians — including a teenager — in separate West Bank shootings Friday. [UNCONFIRMED]** Four European powers (France, Germany, UK, Italy) simultaneously condemned Israel's "E1" settlement project that would cut East Jerusalem off from the West Bank. *(France24 [UNCONFIRMED], BBC [UNCONFIRMED])*</summary>
...
<details markdown="block">
<summary markdown="span">**Over 100 former French and British ambassadors just accused Israel of ethnic cleansing and urged their governments to ban trade and arms sales. [UNCONFIRMED]** The unprecedented joint letter warns the world no longer sees Israel as a genuine democracy. *(France24 [UNCONFIRMED])*</summary>
...
## France-Middle East Diplomacy

<details markdown="block">
<summary markdown="span">**France expelled two Iranian diplomats in retaliation for Tehran blocking two French diplomats from returning; Iran calls the move "illegal."** *(France24)*</summary>

Context: A classic diplomatic tit-for-tat that signals fraying Paris-Tehran ties just as the US ramps up sanctions. France has been trying to preserve the nuclear deal framework; this suggests patience is wearing thin. The expulsions happened as Saudi Crown Prince Mohammed bin Salman arrived in Paris for a two-day state visit.

Sources: [France24](https://www.france24.com/en/middle-east/20260824-iran-calls-france-s-decision-to-expel-two-iranian-diplomats-illegal)

</details>

<details markdown="block">
<summary markdown="span">**Saudi Crown Prince MBS is in Paris chairing the first Saudi-French strategic partnership council with Macron — deals expected on defense, energy, and a Dragon Ball theme park.** *(France24)*</summary>
...
**What to watch:** Whether Iran follows through on threats to hit neighbors' oil infrastructure — that's the tripwire that could drag the Gulf states directly into the economic war.